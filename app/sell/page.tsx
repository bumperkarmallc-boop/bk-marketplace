...
<a className="mt-6" href="https://docs.google.com/forms/d/14-XObKJsrv3lkgUnT5HoO5yWybVLGa7gpocQJYszDYY/viewform" target="_blank" rel="noopener noreferrer">
  ...
  <span className="inline-block mt-6 px-6 py-3 rounded-lg bg-white text-black font-semibold hover:bg-gray-200 transition">
    Join the Creator Waitlist
      ...
      <p className="text-lg text-gray-300 max-w-xl mt-10 text-center">
  A marketplace built for misfits, makers, and rulebreakers. No gatekeepers. No begging. Just create.
</p>
<p className="text-gray-400 text-sm mt-4 text-center">
  No gatekeepers. No begging. No bullshit.
</p>

<p className="text-gray-400 text-sm mt-4">Built for bold, unapologetic creators who want full control.</p>
